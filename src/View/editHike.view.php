<div class="max-w-sm p-6 bg-white border border-gray-200 rounded-lg shadow-md dark:bg-gray-800 dark:border-gray-700 w-[75%]">
    <span class="mb-2 text-2xl font-bold tracking-tight text-gray-900 text-white">Modify a hike !</span>
    <form method="post">
        ...
        <div class="relative z-0 mb-6 w-full group mt-10">
            <input type="text" name="hikeElevation" id="hikeElevation" class="block py-2.5 px-0 w-full text-sm text-gray-900 bg-transparent border-0 border-b-2 border-gray-300 appearance-none dark:text-white dark:border-gray-600 dark:focus:border-white focus:outline-none focus:ring-0 focus:border-white peer" placeholder=" " value="<?=$hike['elevation_gain']?>" required />
        ...
        <div class="relative z-0 mb-6 w-full group mt-10">
            <textarea name="hikeDescription" id="hikeDescription" class="block py-2.5 px-0 w-full text-sm text-gray-900 bg-transparent border-0 border-b-2 border-gray-300 appearance-none dark:text-white dark:border-gray-600 dark:focus:border-white focus:outline-none focus:ring-0 focus:border-white peer" placeholder=" " required><?=$hike['description']?></textarea>
